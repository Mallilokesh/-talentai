    ...
    <>
      ...
      <main className="max-w-3xl mx-auto px-4 py-10">
        <div className="flex items-center gap-3 mb-2">
          ...
          <h1 className="text-xl font-medium">AI Market Intelligence</h1>
        </div>
        <p className="text-gray-500 text-sm mb-8">Real-time insights on the Indian job market, powered by Gemini AI.</p>
        <ErrorBanner message={error}/>
        <div className="card mb-6 space-y-4">
          <div>
            <label className="text-xs text-gray-500 mb-1.5 block">Industry or role</label>
          ...
          <button onClick={getInsight} disabled={loading} className="btn-primary justify-center w-full">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mt-8">
          {[['48K+','Active jobs'],['₹8–80L','Salary range'],['94%','Match accuracy'],['2.4M+','Candidates']].map(([n,l])=>(
